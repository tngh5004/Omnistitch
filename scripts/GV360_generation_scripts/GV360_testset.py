...
WEATHER_PRESETS = {
    ...
    'overcast': [30.0, 0.0, 0.0, 10.0, 1.0, 0.0, 0.9, 6.0],
...
def main():
    ...
    def sensor_callback(sensor_data, sensor_queue, sensor_name, frame = framenum):
        ...
        sensor_data.save_to_disk('H:\Dataset\\raw_dataset\GV360_test_' + str(args.Camera_set_sh) + '_'
                                    + str('val') + '\%05d_%s.png' %(framenum, sensor_name))
    ...
    def setup_rect_camera(bp_lib, world, vehicle_sh, camera_bp, camera_transform, image_w, image_h, fovset, focallengh_x, focallengh_y, optical_x, optical_y):
    ...
    try:
        ...
        if args.Weather_sh == 'clear':
            weather = world.get_weather()
            weather = carla.WeatherParameters(sun_azimuth_angle=30.0, sun_altitude_angle=15.0)
            apply_weather_presets(args.Weather_sh, weather)
            world.set_weather(weather)
            print(f'Weather set done\n')
        elif args.Weather_sh == 'overcast':
            weather = world.get_weather()
            weather = carla.WeatherParameters(sun_azimuth_angle=60.0, sun_altitude_angle=25.0)
            apply_weather_presets(args.Weather_sh, weather)
            world.set_weather(weather)
            print(f'Weather set done\n')
        ...
        traffic_manager.set_global_distance_to_leading_vehicle(0.9 + (int(args.index)*0.1))
        if args.hybrid:
        ...
        if record:
            ...
            if args.Camera_set_sh == 'Baseline_RU':
            ...
            elif args.Camera_set_sh == 'Base_08_RU':
                print('====RU Camera Set activate====') 
                # Set initial camera translation
            ...
            elif args.Camera_set_sh == 'Base_08_LU':
                print('====LU Camera Set activate====') 
                # Set initial camera translation
                camera_init_trans_F = carla.Transform(carla.Location(z=1.762, x=0.55), carla.Rotation(yaw=0))
                # camera_init_trans_B = carla.Transform(carla.Location(z=1.762, x=-0.55), carla.Rotation(yaw=180))
            ...
            elif args.Camera_set_sh == 'Base_08_RD':
                print('====RD Camera Set activate====') 
                # Set initial camera translation
                # camera_init_trans_F = carla.Transform(carla.Location(z=1.762, x=0.55), carla.Rotation(yaw=0))
                camera_init_trans_B = carla.Transform(carla.Location(z=1.762, x=-0.55), carla.Rotation(yaw=180))
            ...
            elif args.Camera_set_sh == 'Base_08_LD':
                print('====LD Camera Set activate====') 
                # Set initial camera translation
                # camera_init_trans_F = carla.Transform(carla.Location(z=1.762, x=0.55), carla.Rotation(yaw=0))
                camera_init_trans_B = carla.Transform(carla.Location(z=1.762, x=-0.55), carla.Rotation(yaw=180))
            ...
            elif args.Camera_set_sh == 'Base_05_RU':
                print('====RU Camera Set activate====') 
                # Set initial camera translation
                camera_init_trans_F = carla.Transform(carla.Location(z=1.762, x=0.44), carla.Rotation(yaw=0))
                # camera_init_trans_B = carla.Transform(carla.Location(z=1.762, x=-0.44), carla.Rotation(yaw=180))
                # camera_init_trans_L = carla.Transform(carla.Location(z=1.762, x=0.0, y=-0.25), carla.Rotation(yaw=-90))
                camera_init_trans_R = carla.Transform(carla.Location(z=1.762, x=(0.0), y=0.25), carla.Rotation(yaw=90))

                camera_init_trans_RU1 = carla.Transform(carla.Location(z=1.762, x=(0.4381), y=(0.0230)), carla.Rotation(yaw=3.0001)) # distance=(0.4387)
                camera_init_trans_RU2 = carla.Transform(carla.Location(z=1.762, x=(0.4327), y=(0.0455)), carla.Rotation(yaw=6.0000)) # distance=(0.4350)
                camera_init_trans_RU3 = carla.Transform(carla.Location(z=1.762, x=(0.4238), y=(0.0671)), carla.Rotation(yaw=9.0000)) # distance=(0.4291)
                camera_init_trans_RU4 = carla.Transform(carla.Location(z=1.762, x=(0.4121), y=(0.0876)), carla.Rotation(yaw=12.0001)) # distance=(0.4213)
                camera_init_trans_RU5 = carla.Transform(carla.Location(z=1.762, x=(0.3980), y=(0.1066)), carla.Rotation(yaw=15.0001)) # distance=(0.4120)
                camera_init_trans_RU6 = carla.Transform(carla.Location(z=1.762, x=(0.3820), y=(0.1241)), carla.Rotation(yaw=18.0002)) # distance=(0.4016)
                camera_init_trans_RU7 = carla.Transform(carla.Location(z=1.762, x=(0.3646), y=(0.1400)), carla.Rotation(yaw=21.0000)) # distance=(0.3905)
                camera_init_trans_RU8 = carla.Transform(carla.Location(z=1.762, x=(0.3463), y=(0.1542)), carla.Rotation(yaw=24.0002)) # distance=(0.3791)
                camera_init_trans_RU9 = carla.Transform(carla.Location(z=1.762, x=(0.3276), y=(0.1669)), carla.Rotation(yaw=27.0002)) # distance=(0.3676)
                camera_init_trans_RU10 = carla.Transform(carla.Location(z=1.762, x=(0.3086), y=(0.1782)), carla.Rotation(yaw=30.0001)) # distance=(0.3564)
                camera_init_trans_RU11 = carla.Transform(carla.Location(z=1.762, x=(0.2897), y=(0.1882)), carla.Rotation(yaw=33.0001)) # distance=(0.3455)
                camera_init_trans_RU12 = carla.Transform(carla.Location(z=1.762, x=(0.2711), y=(0.1969)), carla.Rotation(yaw=36.0002)) # distance=(0.3350)
                camera_init_trans_RU13 = carla.Transform(carla.Location(z=1.762, x=(0.2527), y=(0.2047)), carla.Rotation(yaw=39.0003)) # distance=(0.3252)
                camera_init_trans_RU14 = carla.Transform(carla.Location(z=1.762, x=(0.2348), y=(0.2114)), carla.Rotation(yaw=42.0000)) # distance=(0.3160)
                camera_init_trans_RU15 = carla.Transform(carla.Location(z=1.762, x=(0.2174), y=(0.2174)), carla.Rotation(yaw=45.0002)) # distance=(0.3074)
                camera_init_trans_RU16 = carla.Transform(carla.Location(z=1.762, x=(0.2004), y=(0.2226)), carla.Rotation(yaw=48.0000)) # distance=(0.2995)
                camera_init_trans_RU17 = carla.Transform(carla.Location(z=1.762, x=(0.1839), y=(0.2271)), carla.Rotation(yaw=51.0003)) # distance=(0.2922)
                camera_init_trans_RU18 = carla.Transform(carla.Location(z=1.762, x=(0.1679), y=(0.2311)), carla.Rotation(yaw=54.0000)) # distance=(0.2856)
                camera_init_trans_RU19 = carla.Transform(carla.Location(z=1.762, x=(0.1523), y=(0.2345)), carla.Rotation(yaw=57.0004)) # distance=(0.2797)
                camera_init_trans_RU20 = carla.Transform(carla.Location(z=1.762, x=(0.1371), y=(0.2375)), carla.Rotation(yaw=60.0004)) # distance=(0.2743)
                camera_init_trans_RU21 = carla.Transform(carla.Location(z=1.762, x=(0.1224), y=(0.2401)), carla.Rotation(yaw=63.0004)) # distance=(0.2695)
                camera_init_trans_RU22 = carla.Transform(carla.Location(z=1.762, x=(0.1079), y=(0.2424)), carla.Rotation(yaw=66.0001)) # distance=(0.2653)
                camera_init_trans_RU23 = carla.Transform(carla.Location(z=1.762, x=(0.0938), y=(0.2443)), carla.Rotation(yaw=69.0001)) # distance=(0.2616)
                camera_init_trans_RU24 = carla.Transform(carla.Location(z=1.762, x=(0.0799), y=(0.2458)), carla.Rotation(yaw=72.0000)) # distance=(0.2585)
                camera_init_trans_RU25 = carla.Transform(carla.Location(z=1.762, x=(0.0662), y=(0.2472)), carla.Rotation(yaw=75.0004)) # distance=(0.2559)
                camera_init_trans_RU26 = carla.Transform(carla.Location(z=1.762, x=(0.0528), y=(0.2482)), carla.Rotation(yaw=78.0004)) # distance=(0.2537)
                camera_init_trans_RU27 = carla.Transform(carla.Location(z=1.762, x=(0.0394), y=(0.2490)), carla.Rotation(yaw=81.0000)) # distance=(0.2521)
                camera_init_trans_RU28 = carla.Transform(carla.Location(z=1.762, x=(0.0262), y=(0.2496)), carla.Rotation(yaw=84.0001)) # distance=(0.2509)
                camera_init_trans_RU29 = carla.Transform(carla.Location(z=1.762, x=(0.0131), y=(0.2499)), carla.Rotation(yaw=87.0005)) # distance=(0.2502)

            elif args.Camera_set_sh == 'Base_05_LU':
                print('====LU Camera Set activate====') 
                # Set initial camera translation
                camera_init_trans_F = carla.Transform(carla.Location(z=1.762, x=0.44), carla.Rotation(yaw=0))
                # camera_init_trans_B = carla.Transform(carla.Location(z=1.762, x=-0.44), carla.Rotation(yaw=180))
                ...
                camera_init_trans_LU1 = carla.Transform(carla.Location(z=1.762, x=(0.4381), y=(-0.0230)), carla.Rotation(yaw=-3.0001)) # distance=(0.4387)
                camera_init_trans_LU2 = carla.Transform(carla.Location(z=1.762, x=(0.4327), y=(-0.0455)), carla.Rotation(yaw=-6.0000)) # distance=(0.4350)
                camera_init_trans_LU3 = carla.Transform(carla.Location(z=1.762, x=(0.4238), y=(-0.0671)), carla.Rotation(yaw=-9.0000)) # distance=(0.4291)
                camera_init_trans_LU4 = carla.Transform(carla.Location(z=1.762, x=(0.4121), y=(-0.0876)), carla.Rotation(yaw=-12.0001)) # distance=(0.4213)
                camera_init_trans_LU5 = carla.Transform(carla.Location(z=1.762, x=(0.3980), y=(-0.1066)), carla.Rotation(yaw=-15.0001)) # distance=(0.4120)
                camera_init_trans_LU6 = carla.Transform(carla.Location(z=1.762, x=(0.3820), y=(-0.1241)), carla.Rotation(yaw=-18.0002)) # distance=(0.4016)
                camera_init_trans_LU7 = carla.Transform(carla.Location(z=1.762, x=(0.3646), y=(-0.1400)), carla.Rotation(yaw=-21.0000)) # distance=(0.3905)
                camera_init_trans_LU8 = carla.Transform(carla.Location(z=1.762, x=(0.3463), y=(-0.1542)), carla.Rotation(yaw=-24.0002)) # distance=(0.3791)
                camera_init_trans_LU9 = carla.Transform(carla.Location(z=1.762, x=(0.3276), y=(-0.1669)), carla.Rotation(yaw=-27.0002)) # distance=(0.3676)
                camera_init_trans_LU10 = carla.Transform(carla.Location(z=1.762, x=(0.3086), y=(-0.1782)), carla.Rotation(yaw=-30.0001)) # distance=(0.3564)
                camera_init_trans_LU11 = carla.Transform(carla.Location(z=1.762, x=(0.2897), y=(-0.1882)), carla.Rotation(yaw=-33.0001)) # distance=(0.3455)
                camera_init_trans_LU12 = carla.Transform(carla.Location(z=1.762, x=(0.2711), y=(-0.1969)), carla.Rotation(yaw=-36.0002)) # distance=(0.3350)
                camera_init_trans_LU13 = carla.Transform(carla.Location(z=1.762, x=(0.2527), y=(-0.2047)), carla.Rotation(yaw=-39.0003)) # distance=(0.3252)
                camera_init_trans_LU14 = carla.Transform(carla.Location(z=1.762, x=(0.2348), y=(-0.2114)), carla.Rotation(yaw=-42.0000)) # distance=(0.3160)
                camera_init_trans_LU15 = carla.Transform(carla.Location(z=1.762, x=(0.2174), y=(-0.2174)), carla.Rotation(yaw=-45.0002)) # distance=(0.3074)
                camera_init_trans_LU16 = carla.Transform(carla.Location(z=1.762, x=(0.2004), y=(-0.2226)), carla.Rotation(yaw=-48.0000)) # distance=(0.2995)
                camera_init_trans_LU17 = carla.Transform(carla.Location(z=1.762, x=(0.1839), y=(-0.2271)), carla.Rotation(yaw=-51.0003)) # distance=(0.2922)
                camera_init_trans_LU18 = carla.Transform(carla.Location(z=1.762, x=(0.1679), y=(-0.2311)), carla.Rotation(yaw=-54.0000)) # distance=(0.2856)
                camera_init_trans_LU19 = carla.Transform(carla.Location(z=1.762, x=(0.1523), y=(-0.2345)), carla.Rotation(yaw=-57.0004)) # distance=(0.2797)
                camera_init_trans_LU20 = carla.Transform(carla.Location(z=1.762, x=(0.1371), y=(-0.2375)), carla.Rotation(yaw=-60.0004)) # distance=(0.2743)
                camera_init_trans_LU21 = carla.Transform(carla.Location(z=1.762, x=(0.1224), y=(-0.2401)), carla.Rotation(yaw=-63.0004)) # distance=(0.2695)
                camera_init_trans_LU22 = carla.Transform(carla.Location(z=1.762, x=(0.1079), y=(-0.2424)), carla.Rotation(yaw=-66.0001)) # distance=(0.2653)
                camera_init_trans_LU23 = carla.Transform(carla.Location(z=1.762, x=(0.0938), y=(-0.2443)), carla.Rotation(yaw=-69.0001)) # distance=(0.2616)
                camera_init_trans_LU24 = carla.Transform(carla.Location(z=1.762, x=(0.0799), y=(-0.2458)), carla.Rotation(yaw=-72.0000)) # distance=(0.2585)
                camera_init_trans_LU25 = carla.Transform(carla.Location(z=1.762, x=(0.0662), y=(-0.2472)), carla.Rotation(yaw=-75.0004)) # distance=(0.2559)
                camera_init_trans_LU26 = carla.Transform(carla.Location(z=1.762, x=(0.0528), y=(-0.2482)), carla.Rotation(yaw=-78.0004)) # distance=(0.2537)
                camera_init_trans_LU27 = carla.Transform(carla.Location(z=1.762, x=(0.0394), y=(-0.2490)), carla.Rotation(yaw=-81.0000)) # distance=(0.2521)
                camera_init_trans_LU28 = carla.Transform(carla.Location(z=1.762, x=(0.0262), y=(-0.2496)), carla.Rotation(yaw=-84.0001)) # distance=(0.2509)
                camera_init_trans_LU29 = carla.Transform(carla.Location(z=1.762, x=(0.0131), y=(-0.2499)), carla.Rotation(yaw=-87.0005)) # distance=(0.2502)

            elif args.Camera_set_sh == 'Base_05_RD':
                print('====RD Camera Set activate====') 
                # Set initial camera translation
                # camera_init_trans_F = carla.Transform(carla.Location(z=1.762, x=0.44), carla.Rotation(yaw=0))
                camera_init_trans_B = carla.Transform(carla.Location(z=1.762, x=-0.44), carla.Rotation(yaw=180))
                ...
                camera_init_trans_RD1 = carla.Transform(carla.Location(z=1.762, x=(-0.0131), y=(0.2499)), carla.Rotation(yaw=93.0001)) # distance=(0.2502)
                camera_init_trans_RD2 = carla.Transform(carla.Location(z=1.762, x=(-0.0262), y=(0.2496)), carla.Rotation(yaw=96.0005)) # distance=(0.2509)
                camera_init_trans_RD3 = carla.Transform(carla.Location(z=1.762, x=(-0.0394), y=(0.2490)), carla.Rotation(yaw=99.0000)) # distance=(0.2521)
                camera_init_trans_RD4 = carla.Transform(carla.Location(z=1.762, x=(-0.0528), y=(0.2482)), carla.Rotation(yaw=102.0002)) # distance=(0.2537)
                camera_init_trans_RD5 = carla.Transform(carla.Location(z=1.762, x=(-0.0662), y=(0.2472)), carla.Rotation(yaw=105.0002)) # distance=(0.2559)
                camera_init_trans_RD6 = carla.Transform(carla.Location(z=1.762, x=(-0.0799), y=(0.2458)), carla.Rotation(yaw=108.0000)) # distance=(0.2585)
                camera_init_trans_RD7 = carla.Transform(carla.Location(z=1.762, x=(-0.0938), y=(0.2443)), carla.Rotation(yaw=111.0005)) # distance=(0.2616)
                camera_init_trans_RD8 = carla.Transform(carla.Location(z=1.762, x=(-0.1079), y=(0.2424)), carla.Rotation(yaw=114.0004)) # distance=(0.2653)
                camera_init_trans_RD9 = carla.Transform(carla.Location(z=1.762, x=(-0.1224), y=(0.2401)), carla.Rotation(yaw=117.0002)) # distance=(0.2695)
                camera_init_trans_RD10 = carla.Transform(carla.Location(z=1.762, x=(-0.1371), y=(0.2375)), carla.Rotation(yaw=120.0001)) # distance=(0.2743)
                camera_init_trans_RD11 = carla.Transform(carla.Location(z=1.762, x=(-0.1523), y=(0.2345)), carla.Rotation(yaw=123.0002)) # distance=(0.2797)
                camera_init_trans_RD12 = carla.Transform(carla.Location(z=1.762, x=(-0.1679), y=(0.2311)), carla.Rotation(yaw=126.0000)) # distance=(0.2856)
                camera_init_trans_RD13 = carla.Transform(carla.Location(z=1.762, x=(-0.1839), y=(0.2271)), carla.Rotation(yaw=129.0002)) # distance=(0.2922)
                camera_init_trans_RD14 = carla.Transform(carla.Location(z=1.762, x=(-0.2004), y=(0.2226)), carla.Rotation(yaw=132.0000)) # distance=(0.2995)
                camera_init_trans_RD15 = carla.Transform(carla.Location(z=1.762, x=(-0.2174), y=(0.2174)), carla.Rotation(yaw=135.0002)) # distance=(0.3074)
                camera_init_trans_RD16 = carla.Transform(carla.Location(z=1.762, x=(-0.2348), y=(0.2114)), carla.Rotation(yaw=138.0000)) # distance=(0.3160)
                camera_init_trans_RD17 = carla.Transform(carla.Location(z=1.762, x=(-0.2527), y=(0.2046)), carla.Rotation(yaw=141.0001)) # distance=(0.3252)
                camera_init_trans_RD18 = carla.Transform(carla.Location(z=1.762, x=(-0.2711), y=(0.1969)), carla.Rotation(yaw=144.0001)) # distance=(0.3350)
                camera_init_trans_RD19 = carla.Transform(carla.Location(z=1.762, x=(-0.2897), y=(0.1882)), carla.Rotation(yaw=147.0002)) # distance=(0.3455)
                camera_init_trans_RD20 = carla.Transform(carla.Location(z=1.762, x=(-0.3086), y=(0.1782)), carla.Rotation(yaw=150.0002)) # distance=(0.3564)
                camera_init_trans_RD21 = carla.Transform(carla.Location(z=1.762, x=(-0.3276), y=(0.1669)), carla.Rotation(yaw=153.0001)) # distance=(0.3676)
                camera_init_trans_RD22 = carla.Transform(carla.Location(z=1.762, x=(-0.3463), y=(0.1542)), carla.Rotation(yaw=156.0001)) # distance=(0.3791)
                camera_init_trans_RD23 = carla.Transform(carla.Location(z=1.762, x=(-0.3646), y=(0.1400)), carla.Rotation(yaw=159.0000)) # distance=(0.3905)
                camera_init_trans_RD24 = carla.Transform(carla.Location(z=1.762, x=(-0.3820), y=(0.1241)), carla.Rotation(yaw=162.0001)) # distance=(0.4016)
                camera_init_trans_RD25 = carla.Transform(carla.Location(z=1.762, x=(-0.3980), y=(0.1066)), carla.Rotation(yaw=165.0002)) # distance=(0.4120)
                camera_init_trans_RD26 = carla.Transform(carla.Location(z=1.762, x=(-0.4121), y=(0.0876)), carla.Rotation(yaw=168.0001)) # distance=(0.4213)
                camera_init_trans_RD27 = carla.Transform(carla.Location(z=1.762, x=(-0.4238), y=(0.0671)), carla.Rotation(yaw=171.0000)) # distance=(0.4291)
                camera_init_trans_RD28 = carla.Transform(carla.Location(z=1.762, x=(-0.4327), y=(0.0455)), carla.Rotation(yaw=174.0000)) # distance=(0.4350)
                camera_init_trans_RD29 = carla.Transform(carla.Location(z=1.762, x=(-0.4381), y=(0.0230)), carla.Rotation(yaw=177.0001)) # distance=(0.4387)
                
            elif args.Camera_set_sh == 'Base_05_LD':
                print('====LD Camera Set activate====') 
                # Set initial camera translation
                # camera_init_trans_F = carla.Transform(carla.Location(z=1.762, x=0.44), carla.Rotation(yaw=0))
                camera_init_trans_B = carla.Transform(carla.Location(z=1.762, x=-0.44), carla.Rotation(yaw=180))
                ...
                camera_init_trans_LD1 = carla.Transform(carla.Location(z=1.762, x=(-0.0131), y=(-0.2499)), carla.Rotation(yaw=-93.0001)) # distance=(0.2502)
                camera_init_trans_LD2 = carla.Transform(carla.Location(z=1.762, x=(-0.0262), y=(-0.2496)), carla.Rotation(yaw=-96.0005)) # distance=(0.2509)
                camera_init_trans_LD3 = carla.Transform(carla.Location(z=1.762, x=(-0.0394), y=(-0.2490)), carla.Rotation(yaw=-99.0000)) # distance=(0.2521)
                camera_init_trans_LD4 = carla.Transform(carla.Location(z=1.762, x=(-0.0528), y=(-0.2482)), carla.Rotation(yaw=-102.0002)) # distance=(0.2537)
                camera_init_trans_LD5 = carla.Transform(carla.Location(z=1.762, x=(-0.0662), y=(-0.2472)), carla.Rotation(yaw=-105.0002)) # distance=(0.2559)
                camera_init_trans_LD6 = carla.Transform(carla.Location(z=1.762, x=(-0.0799), y=(-0.2458)), carla.Rotation(yaw=-108.0000)) # distance=(0.2585)
                camera_init_trans_LD7 = carla.Transform(carla.Location(z=1.762, x=(-0.0938), y=(-0.2443)), carla.Rotation(yaw=-111.0005)) # distance=(0.2616)
                camera_init_trans_LD8 = carla.Transform(carla.Location(z=1.762, x=(-0.1079), y=(-0.2424)), carla.Rotation(yaw=-114.0004)) # distance=(0.2653)
                camera_init_trans_LD9 = carla.Transform(carla.Location(z=1.762, x=(-0.1224), y=(-0.2401)), carla.Rotation(yaw=-117.0002)) # distance=(0.2695)
                camera_init_trans_LD10 = carla.Transform(carla.Location(z=1.762, x=(-0.1371), y=(-0.2375)), carla.Rotation(yaw=-120.0001)) # distance=(0.2743)
                camera_init_trans_LD11 = carla.Transform(carla.Location(z=1.762, x=(-0.1523), y=(-0.2345)), carla.Rotation(yaw=-123.0002)) # distance=(0.2797)
                camera_init_trans_LD12 = carla.Transform(carla.Location(z=1.762, x=(-0.1679), y=(-0.2311)), carla.Rotation(yaw=-126.0000)) # distance=(0.2856)
                camera_init_trans_LD13 = carla.Transform(carla.Location(z=1.762, x=(-0.1839), y=(-0.2271)), carla.Rotation(yaw=-129.0002)) # distance=(0.2922)
                camera_init_trans_LD14 = carla.Transform(carla.Location(z=1.762, x=(-0.2004), y=(-0.2226)), carla.Rotation(yaw=-132.0000)) # distance=(0.2995)
                camera_init_trans_LD15 = carla.Transform(carla.Location(z=1.762, x=(-0.2174), y=(-0.2174)), carla.Rotation(yaw=-135.0002)) # distance=(0.3074)
                camera_init_trans_LD16 = carla.Transform(carla.Location(z=1.762, x=(-0.2348), y=(-0.2114)), carla.Rotation(yaw=-138.0000)) # distance=(0.3160)
                camera_init_trans_LD17 = carla.Transform(carla.Location(z=1.762, x=(-0.2527), y=(-0.2046)), carla.Rotation(yaw=-141.0001)) # distance=(0.3252)
                camera_init_trans_LD18 = carla.Transform(carla.Location(z=1.762, x=(-0.2711), y=(-0.1969)), carla.Rotation(yaw=-144.0001)) # distance=(0.3350)
                camera_init_trans_LD19 = carla.Transform(carla.Location(z=1.762, x=(-0.2897), y=(-0.1882)), carla.Rotation(yaw=-147.0002)) # distance=(0.3455)
                camera_init_trans_LD20 = carla.Transform(carla.Location(z=1.762, x=(-0.3086), y=(-0.1782)), carla.Rotation(yaw=-150.0002)) # distance=(0.3564)
                camera_init_trans_LD21 = carla.Transform(carla.Location(z=1.762, x=(-0.3276), y=(-0.1669)), carla.Rotation(yaw=-153.0001)) # distance=(0.3676)
                camera_init_trans_LD22 = carla.Transform(carla.Location(z=1.762, x=(-0.3463), y=(-0.1542)), carla.Rotation(yaw=-156.0001)) # distance=(0.3791)
                camera_init_trans_LD23 = carla.Transform(carla.Location(z=1.762, x=(-0.3646), y=(-0.1400)), carla.Rotation(yaw=-159.0000)) # distance=(0.3905)
                camera_init_trans_LD24 = carla.Transform(carla.Location(z=1.762, x=(-0.3820), y=(-0.1241)), carla.Rotation(yaw=-162.0001)) # distance=(0.4016)
                camera_init_trans_LD25 = carla.Transform(carla.Location(z=1.762, x=(-0.3980), y=(-0.1066)), carla.Rotation(yaw=-165.0002)) # distance=(0.4120)
                camera_init_trans_LD26 = carla.Transform(carla.Location(z=1.762, x=(-0.4121), y=(-0.0876)), carla.Rotation(yaw=-168.0001)) # distance=(0.4213)
                camera_init_trans_LD27 = carla.Transform(carla.Location(z=1.762, x=(-0.4238), y=(-0.0671)), carla.Rotation(yaw=-171.0000)) # distance=(0.4291)
                camera_init_trans_LD28 = carla.Transform(carla.Location(z=1.762, x=(-0.4327), y=(-0.0455)), carla.Rotation(yaw=-174.0000)) # distance=(0.4350)
                camera_init_trans_LD29 = carla.Transform(carla.Location(z=1.762, x=(-0.4381), y=(-0.0230)), carla.Rotation(yaw=-177.0001)) # distance=(0.4387)

            elif args.Camera_set_sh == 'Base_00_RU': # 1.97 30
                print('====RU Camera Set activate====') 
                # Set initial camera translation
            ...
            elif args.Camera_set_sh == 'Base_00_LU':
                print('====LU Camera Set activate====') 
                # Set initial camera translation
                camera_init_trans_F = carla.Transform(carla.Location(z=1.762, x=0.01), carla.Rotation(yaw=0))
                # camera_init_trans_B = carla.Transform(carla.Location(z=2.3, x=-0.44), carla.Rotation(yaw=180))
            ...
            elif args.Camera_set_sh == 'Base_00_RD':
                print('====RD Camera Set activate====') 
                # Set initial camera translation
            ...
            elif args.Camera_set_sh == 'Base_00_LD':
                print('====LD Camera Set activate====') 
                # Set initial camera translation
                # camera_init_trans_F = carla.Transform(carla.Location(z=2.3, x=0.44), carla.Rotation(yaw=0))
                camera_init_trans_B = carla.Transform(carla.Location(z=1.762, x=-0.01), carla.Rotation(yaw=180))
        ...
        if args.Map_sh == 'Town10HD':
            framenum = 0
        elif args.Map_sh == 'Town05':
            framenum += 100
        elif args.Map_sh == 'Town03':
            framenum += 200
        #framenum = 0 
        framenum += (int(args.index)) * 1
        framenum += (int(args.seed) // 1123) * 10
        
        waitingtime = (framenum) + 10
